"""This module contains 'MissCatboosts' code."""

__all__ = ["MissCatboosts"]
__version__ = "1.1.1"
__author__ = "liuliang yong"
...
class MissCatboosts:
    ...
    def __init__(self, clf: Union[Any, BaseEstimator] = CatBoostClassifier(),
                 rgr: Union[Any, BaseEstimator] = CatBoostRegressor(),
